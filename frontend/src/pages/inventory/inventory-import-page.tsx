        ...
        <form className="mt-5 space-y-5" onSubmit={(event) => void validate(event)}>
          ...
          <div className="rounded-[8px] border border-[var(--color-border)] p-5">
            ...
            <p className="mt-1 text-sm text-[var(--color-text-muted)]">
              ...
              {mode === 'SERIALIZED'
                ? ' Required columns: IT Asset, Type/Model Name, Serial Number, Location, Block, Department. Optional columns: Vendor Name, Description, Inventory Status.'
                : ' Required columns: IT Consumable, Type/Model Name, Quantity, Unit Label, Location, Block, Department. Optional columns: Vendor Name, Return Policy, Description, Inventory Status.'}
            </p>
            <p className="mt-1 text-sm text-[var(--color-text-muted)]">
              IT Asset, IT Consumable, Location, Block, and Department are matched from saved asset details; spacing and letter case are ignored. Vendor Name is saved as entered.
            </p>
            <p className="mt-1 text-sm text-[var(--color-text-muted)]">
